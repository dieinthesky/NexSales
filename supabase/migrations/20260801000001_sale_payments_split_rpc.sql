-- ============================================================
-- Passo 2/2: tabela sale_payments + RPC create_sale_with_items
-- Rode DEPOIS do passo 1 (enum 'mixed' já commitado).
-- ============================================================
...
CREATE TABLE IF NOT EXISTS public.sale_payments (
  ...
  CONSTRAINT sale_payments_method_not_mixed CHECK (payment_method::text <> 'mixed')
);
